...
1. Compute orthogonal groups for the relevant quadratic forms.
 ...
 To write the projective orthogonal group of vw + x^2 + y^2 in
   GF(3)[v,w,x,y,z] to the file `POQ_vw_xx_yy.data`:
 ...
 To write the (projective) orthogonal group of vw + xy + z^2 in
   GF(4)[v,w,x,y,z] to the file `POQ_vw_xy_zz.data`:
